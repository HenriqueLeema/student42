...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/05 20:12:20 by hde-souz          #+#    #+#             */
/*   Updated: 2023/12/09 17:42:58 by hde-souz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Simulates basic printf behavior
 *
 * @note 1. Supports %csdupxX
 * @note 2. Doesn't support tags
 */
int	ft_printf(const char *fmt, ...);
int	ft_putstr(char *str); // both for printf
int	ft_putchar(char c);  //
int	ft_parsef(char fmt, va_list ap);

/**
 * @brief Converts the initial part of the string pointed
 * to by 'nptr' to int
 *
 ...
 *
 * @param c Equivalent to isalpha || isdigit
 **/
 ...
 *
 * @param c Matches az || AZ according to ASCII
 **/
 ...
 *
 * @param c Matches 0 through 9 according to ASCII
 **/
int			ft_isdigit(int c);

/**
 * @brief Checks for a 7-bit unsigned char value
 *
 * @param c Is a character that fits the ASCII character set
 **/
 ...
 *
 * @param c Is between 32 and 126 in ASCII
 **/
...
/**
 * @brief Appends the NULL-terminated
 ...
 * 's'. Each char is passed by address to 'f' to be modif if needed
 *
 * @param s The string on which to iterate
